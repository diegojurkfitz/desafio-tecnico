# Desafio Tecnico - Analise de Trafego de Rede e Prompt de IA

Resolucao dos challenges tecnicos focados em **Desenvolvimento** e **Inteligencia Artificial**.
...
## Challenge 02 - Prompt de IA para Analise de Logs

Prompt estruturado para uso com IAs generativas (ChatGPT, Claude, Gemini) para analise de logs de infraestrutura.

Documentacao completa em: [`docs/challenge-02-prompt-analise-logs.md`](./docs/challenge-02-prompt-analise-logs.md)
